...
- **Eje institucional**: matriz servicios×años (mayores más los fijados, con desplegable para el resto) desde la que se abre un servicio completo o un servicio en un año concreto, para ver su proveedor de mayor influencia, en qué gastó (subtítulo e ítem) y cómo se comportó en el tiempo. Buscador sobre el universo completo, no sólo los mayores.
